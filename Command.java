public class Command {
    void commandList (){
        ...
        System.out.println("| 0x0000b MOV R4, 0x00A0   | -> |     0x0000     | 1011 100 010100000   |");
        System.out.println("| 0x0010b MOV R5, 0x0002   | -> |     0x0010     | 1011 101 000000010   |");
        System.out.println("| 0x0020b LOAD R1, R4, R5  | -> |     0x0020     | 0001 001 100 000 101 |");
        System.out.println("| 0x0030b ADD R2, R1, #4   | -> |     0x0030     | 1000 010 001 1 00100 |");
